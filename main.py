...
/info - посмотреть список всех команд
/projects - увидеть список проектов
/delete - удалить проект
/skills - добавить навыки для проекта
/update_projects - обновить информацию о проекте

Просто отправь имя проекта, чтобы узнать информацию о нем!
""")
...
def description_project(message, data):
    data.append(message.text)  # Добавляем описание в данные
